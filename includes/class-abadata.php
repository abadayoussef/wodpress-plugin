...
class Abadata
{
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Abadata_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Abadata_Loader. Orchestrates the hooks of the plugin.
	 * - Abadata_i18n. Defines internationalization functionality.
	 * - Abadata_Admin. Defines all hooks for the admin area.
	 * - Abadata_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Abadata_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Abadata_Loader    Orchestrates the hooks of the plugin.
	 */
